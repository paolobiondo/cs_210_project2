...
public class LinkedDeque<Item> implements Iterable<Item> {
    Node first; // pointer to the front of deque
    Node last; // pointer to the back of deque
    ...
    public Item removeFirst() {
        ...
        Item popItem; // the item that will be removed from the deque
        if (n == 1) {
            popItem = first.item;
            first = null;
            last = null;
    ...
    private class DequeIterator implements Iterator<Item> {
        private Node current; // a pointer to the current element inside the the Deque
